...
param_scheduler = [
    dict(type='LinearLR', start_factor=1e-05, by_epoch=False, begin=0, end=50),
    dict(
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=
    'data/Drink_284_Detection_coco/Drink_284_Detection_coco/val_coco.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            prefix='backbone.',
            checkpoint='checkpoint/cspnext-tiny_imagenet_600e.pth'),
        frozen_stages=4),
    neck=dict(
        type='CSPNeXtPAFPN',
...
launcher = 'none'
work_dir = './work_dirs/rtm-det_100e'
