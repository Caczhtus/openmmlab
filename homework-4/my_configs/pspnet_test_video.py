...
# 模型 config 配置文件
config_file = 'my_configs/pspnet_HomeworkDataset_20230616.py'
...
input_video = 'data/test/xigua.mp4'
...
# 把每一帧串成视频文件
mmcv.frames2video(temp_out_dir, 'data/test/xigua_pred.mp4', fps=imgs.fps, fourcc='mp4v')
